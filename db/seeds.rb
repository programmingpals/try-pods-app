...
Friendship.create(user_id: 2, friend_id: 10)
Friendship.create(user_id: 2, friend_id: 13)
Friendship.create(user_id: 2, friend_id: 11)
Friendship.create(user_id: 2, friend_id: 9)
Friendship.create(user_id: 3, friend_id: 1)
Friendship.create(user_id: 3, friend_id: 2)
Friendship.create(user_id: 3, friend_id: 10)
Friendship.create(user_id: 3, friend_id: 7)
Friendship.create(user_id: 3, friend_id: 8)
Friendship.create(user_id: 3, friend_id: 5)
Friendship.create(user_id: 3, friend_id: 9)