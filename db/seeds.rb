...
rowlist = List.create(user_id: 1, name: "other faves", description: "description", series: true)

rowlist = List.create(user_id: 1, name: "okay", description: "petey", series: true)
